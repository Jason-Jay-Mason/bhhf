...
div.iconGrid = styled.div`
  ...
  .grid {
    ...
    .column {
      ...
      width: 95%;
      max-width: 300px;
      background-color: ${colors.rainCloudBeigeOverlay};
...
const FeaturedIconGrid = ({ standardHeadline, standardSubHeadline, backgroundImageSrc, maxColumns, iconSections }) => {
  return (
    <Section>
      <div.iconGrid maxColumns={maxColumns}>
        {standardHeadline && standardSubHeadline && <MainHeadline headline={standardHeadline ? standardHeadline : "No Headline..."} subHeadline={standardSubHeadline ? standardSubHeadline : "No SubHeadline..."} />}
